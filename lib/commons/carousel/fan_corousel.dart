...
import 'package:lenskart_test/commons/carousel/arrow_navs.dart';
import 'package:lenskart_test/commons/carousel/indicators_widget.dart';
import 'package:lenskart_test/commons/carousel/slide_widget.dart';
...
class FanCarouselImageSlider extends StatefulWidget {
  const FanCarouselImageSlider({
    ...
    required this.currentIndexListener,
    required this.onTap,
  ...
  final ValueNotifier<int> currentIndexListener;
...
class _FanCarouselImageSliderState extends State<FanCarouselImageSlider> {
  ...
  void initState() {
    ...
    widget.currentIndexListener.value = _currentIndex.value;
